...
#define AND    60 // &
#define OR     61 // |
#define RA     62 // ->  RIGHT ARROW
#define LA     63 // <- LEFT ARRPOW
#define DA     64 // <-> DOUBLE ARROW
#define UNIVERSAL    65 // @ UNIVERSAL
#define EXISTENTIAL    66 // # EXISTENTIAL
#define OBJ_FUNC   67 // const_obj_func
#define EQ     68 // = EQUAL
#define NEG    69 // ~
#define OP_LOG_BIN 70
//some others needes are already defined (like VAr, LT, rct)
